...
import { ExternalLinkIcon, PencilSquareIcon, PinIcon, TrashIcon } from "@/components/ui/icons";
...
export function TaskListMenu({ task, onRename, onOpenInNewTab, onTogglePin, onDelete }: TaskListMenuProps) {
