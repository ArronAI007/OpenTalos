...
import { ExternalLinkIcon, PencilSquareIcon, TrashIcon } from "@/components/ui/icons";
...
export function TaskListMenu({ task, onRename, onOpenInNewTab, onDelete }: TaskListMenuProps) {
